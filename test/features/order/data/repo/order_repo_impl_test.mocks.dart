...
// in coffe_shop/test/features/order/data/repo/order_repo_impl_test.dart.
...
import 'package:coffe_shop/features/order/data/models/order_model.dart' as _i8;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockFirestoreHelper extends _i1.Mock implements _i7.FirestoreHelper {
  MockFirestoreHelper() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<void> addOrder(_i8.OrderModel? order) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<_i8.OrderModel?> getOrderById(String? orderId) =>
      (super.noSuchMethod(
            Invocation.method(#getOrderById, [orderId]),
            returnValue: _i4.Future<_i8.OrderModel?>.value(),
          )
          as _i4.Future<_i8.OrderModel?>);

  @override
  _i4.Future<List<_i8.OrderModel>> getAllOrders() =>
      (super.noSuchMethod(
            Invocation.method(#getAllOrders, []),
            returnValue: _i4.Future<List<_i8.OrderModel>>.value(
              <_i8.OrderModel>[],
            ),
          )
          as _i4.Future<List<_i8.OrderModel>>);

  @override
  _i4.Future<_i9.CoffeeModel?> getCoffeeById(String? coffeeId) =>
      (super.noSuchMethod(
            Invocation.method(#getCoffeeById, [coffeeId]),
            returnValue: _i4.Future<_i9.CoffeeModel?>.value(),
          )
          as _i4.Future<_i9.CoffeeModel?>);

  @override
  _i4.Future<List<_i9.CoffeeModel>> getAllCoffees() =>
      (super.noSuchMethod(
            Invocation.method(#getAllCoffees, []),
            returnValue: _i4.Future<List<_i9.CoffeeModel>>.value(
              <_i9.CoffeeModel>[],
            ),
          )
          as _i4.Future<List<_i9.CoffeeModel>>);

  @override
  _i4.Future<List<_i9.CoffeeModel>> searchCoffees(String? query) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Stream<List<_i8.OrderModel>> getOrdersStream() =>
      (super.noSuchMethod(
            Invocation.method(#getOrdersStream, []),
            returnValue: _i4.Stream<List<_i8.OrderModel>>.empty(),
          )
          as _i4.Stream<List<_i8.OrderModel>>);

  @override
  _i4.Future<void> acceptOrder({
    required _i10.DeleiveryModel? deleveryModel,
